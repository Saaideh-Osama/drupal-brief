...
class __TwigTemplate_ca9fa8fa407e3a434661c71041049352 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div";
            // line 90
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["author_attributes"] ?? null), "addClass", [0 => "node-submitted-details"], "method", false, false, true, 90), 90, $this->source), "html", null, true);
            echo ">
      ";
            // line 91
...
";
    ...
    {
        return new Source("", "themes/contrib/xara/templates/content/node.html.twig", "C:\\xampp\\htdocs\\drupal9\\themes\\contrib\\xara\\templates\\content\\node.html.twig");
    }
