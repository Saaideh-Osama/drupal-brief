...
class __TwigTemplate_8e71c4ce7a6c42b539ce9eece1a78344 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 17
        echo "<li";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ((($context["is_active"] ?? null)) ? ("active") : ("")), 1 => "page-item"], "method", false, false, true, 17), 17, $this->source), "html", null, true);
        echo ">
    <a href=\"";
        // line 18
...
";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/menu-local-task.html.twig", "C:\\xampp\\htdocs\\drupal9\\themes\\contrib\\dxpr_theme\\templates\\menu-local-task.html.twig");
    }
